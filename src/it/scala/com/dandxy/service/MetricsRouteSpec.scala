...
class MetricsRouteSpec extends MockRouteTestData {
  ...
  it should "display the best X shots per round" in {
    ...
    val res = metricsRoute(req).value.unsafeRunSync()
    val expectedResultBody = """[{"hole":10,"shot":3,"par":4,"distance":200.0,"ballLocation":2,"club":19,"strokesGained":-0.4,"strokesIndex":3}]"""
  ...
  it should "display the worst X shots per round" in {
    ...
    val res = metricsRoute(req).value.unsafeRunSync()
    val expectedResultBody = """[{"hole":10,"shot":3,"par":4,"distance":200.0,"ballLocation":2,"club":19,"strokesGained":1.4,"strokesIndex":3}]"""
