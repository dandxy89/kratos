...
async def gather_player_data(data_dir, data_url, pid):
    fetch_and_save(
        ...
        for yr in YEARS:
            ...
            if tid not in ["002", "003"]:
                ...
                summary = fetch_and_save(
                    "{}/leaderboard-v2.json".format(data_url), data_dir, "summary.json",
                )
                ...
                async def main_player():
                    job = [
                        gather_player_data(data_dir, data_url, player_id)
